...
class tax_report(report_sxw.rml_parse, common_report_header):
    ...
    def _get_lines(self, fiscalyear_id, chart_tax_id, context=None):
        ...
        while i < len(res):
            ...
            res_general = self._get_general(res[i][1]['id'], fiscalyear_id, context=context)
            ind_general = 0
    ...
    def _get_general(self, fiscalyear_id, context=None):
        ...
        self.cr.execute("SELECT  account_move_line.id, \
...
class zen_report_vat(osv.AbstractModel):
    _name = 'report.zenawtol.zen_report_vat3'
    _inherit = 'report.abstract_report'
    _template = 'zenawtol.zenreport_vattemplate'
