...
class Machine(models.Model):
    ...
    choix_moteur=fields.Boolean(string="Acutualisation Numero")
    nouveau_moteur=fields.Char(string='Nouveau Numéro')
    num_serie_trois = fields.Char(string="N° de série de l'altérnateur")
    choix_alternateur=fields.Boolean(string="Acutualisation Numero")
    nouveau_alternateur=fields.Char(string='Nouveau Numéro')
