...
class report_crossoveredbudgetconso(osv.AbstractModel):
    _name = 'report.account_budget_conso.report_crossoveredbudgetconso'
    _inherit = 'report.abstract_report'
    _template = 'account_budget_conso.report_crossoveredbudgetconso'
