...
class crossovered_budget_lines(osv.osv):
	...
	def _ecart(self, cr, uid, ids, name, agrs, context=None):
		res = {}
		for line in self.browse(cr, uid, ids, context=context):
			res[line.id] = float(line.planned_amount - line.practical_amount)
		return res
	...
	_columns = {
		...
		'ecart_amount':fields.function(_ecart, string='Ecart_Budgetaire', type='float', digits_compute=dp.get_precision('Account')),
